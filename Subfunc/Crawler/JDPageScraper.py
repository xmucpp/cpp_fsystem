...
def parse_html(html, url, page_num, cate, sort):
    ...
    try:
        ...
        try:
            prices = json.loads(get_html('{}{}'.format('http://p.3.cn/prices/mgets?http://p.3.cn/prices/mgets?type=1&area=1_72_4137_0&pdbp=0&pdtk=&pdpin=&pduid=14875031659431915603908&skuIds=', IDprice)))
